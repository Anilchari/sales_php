...
<!-- Mirrored from demo.dashboardpack.com/sales-html/apex_chart.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 15:50:16 GMT -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="dashboard_breadcam text-end">
                                        <p><a href="index-2.php">Dashboard</a> <i class="fas fa-caret-right"></i> Apex
                                            Chart </p>
                                    </div>
                                </div>
                            </div>
