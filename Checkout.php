...
<!-- Mirrored from demo.dashboardpack.com/sales-html/Checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 15:50:06 GMT -->
<head>
...
<h3 class="f_s_30 f_w_700 text_white">Checkout</h3>
...
<label class="form-label custom-control-label" for="horizontalCheckbox">Confirm Shipping Address</label>
</div>
</div>
</div>
</div>
...
<div class="row">
<div class="col-md-12">
<div class="mb-3"><label class="form-label" for="Card_No">Card No :</label> <input type="text" class="form-control" id="Card_No" required placeholder="1234-5678-9123-4567" /></div>
</div>
...
<div class="col-md-4">
<div class="mb-3 mb-lg-0">
<label for="select_year" class="form-label me-2">Expiry Year</label>
...
<div class="col-md-4">
<div class="mb-3 mb-lg-0">
<label class="form-label" for="CVV_Code">Security Code</label>
...
<!-- Mirrored from demo.dashboardpack.com/sales-html/Checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 15:50:08 GMT -->
</html>
