...
$data = $conn->query("SELECT p.product_id, p.product_name, p.price, p.description, c.name AS name, p.image_url 
                     FROM `products` p 
...
<!-- Mirrored from demo.dashboardpack.com/sales-html/Products.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 15:50:03 GMT -->
<head>
...
<a href="productreport.php" class="white_btn3">Create Report</a>
</div>
</div>
</div>
<div class="container">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php foreach ($allData as $dataVal) { ?>
                            <tr>
                                <th scope="row"><?php echo $dataVal['product_id']; ?></th>
                                <td><?= $dataVal['product_name']; ?></td>
                                <td><?= $dataVal['price']; ?></td>
                                <td><?= $dataVal['description']; ?></td>
                                <td><?= $dataVal['name']; ?></td>
                                <td><img src="img/<?= $dataVal['image_url']; ?>" alt="Product Image" width="70px"></td>
                                <td>
                                    <button class="btn btn-primary mr-2">
                                        <a href="edit.php?id=<?php echo $dataVal['product_id']; ?>" class="text-light">Update</a>
                                    </button>
                                    <button class="btn btn-danger">
                                        <a href="delete1.php?deleteid=<?php echo $dataVal['product_id']; ?>" class="text-light">Delete</a>
                                    </button>
                                </td>
                            </tr>
                        <?php } ?>
...
<!-- Mirrored from demo.dashboardpack.com/sales-html/Products.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 15:50:06 GMT -->
</html>
