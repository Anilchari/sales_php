...
if (isset($_POST['submit'])) {
    ...
    if (empty($error)) {
        ...
        if ($result) {
            ...
            // Store the category id in a session variable
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="dashboard_breadcrumb text-end">
                                        <p><a href="index-2.php">Dashboard</a> <i class="fas fa-caret-right"></i>
                                            Register</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="modal-content cs_modal">
                                        <div class="modal-header theme_bg_1 justify-content-center">
                                            <h5 class="modal-title text_white">category name</h5>
                                        </div>
                                        <div class="modal-body">
                                            <form method="post">
                                                ...
                                                <button href="category.php" class="btn_1 full_width text-center"
