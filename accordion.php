...
<!-- Mirrored from demo.dashboardpack.com/sales-html/accordion.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 15:50:14 GMT -->
...
<body class="crm_body_bg">
    ...
    <nav class="sidebar vertical-scroll  ps-container ps-theme-default ps-active-y">
        ...
        <ul id="sidebar_menu">
            <li class="mm-active">
                ...
                <ul>
                    <li><a class="active" href="index-2.php">Sales</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="dashboard_breadcam text-end">
                                        <p><a href="index-2.php">Dashboard</a> <i
                                                class="fas fa-caret-right"></i>Accordion</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card_box box_shadow position-relative mb_30">
                            <div class="white_box_tittle ">
                                <div class="main-title2 ">
                                    ...
                                    <p>Using the card component, you can extend the default collapse behavior to create
                                        an accordion</p>
                                </div>
                            </div>
                            <div class="box_body">
                                        ...
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                <button class="btn  collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapseOne">Collapsible Group Item #<span
                                                        class="digits">1</span></button>
                                            </h5>
                                        </div>
                                        ...
                                        <div class="card-header" id="headingTwo">
                                            <h5 class="mb-0">
                                                <button class="btn  collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapseTwo">Collapsible Group Item #<span
                                        ...
                                        <div class="card-header" id="headingThree">
                                            <h5 class="mb-0">
                                                <button class="btn  collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapseThree">Collapsible Group Item #<span
                                        ...
                                        <div class="card-header" id="heading1">
                                            <h5 class="mb-0">
                                                <button class="btn " data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="heading1">Collapsible Group Item #<span
                                                        class="digits">1</span></button>
                                            </h5>
                                        </div>
                        ...
                        <div class="card_box box_shadow position-relative mb_30">
                            <div class="white_box_tittle ">
                                <div class="main-title2 ">
                                    ...
                                    <p>Add <strong class="color_pink">.pink_bg*</strong> class to add background color
                                        with card-header.</p>
                                </div>
                            </div>
                            <div class="box_body">
                                ...
                                <div class="default-according" id="accordion1">
                                        ...
                                        <div class="card-header pink_bg" id="headingFour">
                                            <h5 class="mb-0">
                                                <button class="btn  text_white collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapseFour">Collapsible Group Item #<span
                                                        class="digits">1</span></button>
                                            </h5>
                                        </div>
                                        <div class="collapse" id="collapseFour" aria-labelledby="headingOne"
                                    ...
                                    <div class="card">
                                        <div class="card-header pink_bg" id="headingFive">
                                            <h5 class="mb-0">
                                                <button class="btn  collapsed text_white" data-bs-toggle="collapse"
                                                    data-bs-target="#collapseFive" aria-expanded="false"
                                                    aria-controls="collapseFive">Collapsible Group Item #<span
                                                        class="digits">2</span></button>
                                            </h5>
                                        </div>
                                        ...
                                        <div class="card-header pink_bg" id="headingSix">
                                            <h5 class="mb-0">
                                                <button class="btn  collapsed text_white" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapseSix">Collapsible Group Item #<span
                                                        class="digits">3</span></button>
                                            </h5>
                                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card_box box_shadow position-relative mb_30">
                            <div class="white_box_tittle ">
                                <div class="main-title2 ">
                                    <h4 class="mb-2 nowrap">Color Accordion</h4>
                                    <p>Add <strong class="color_parpel">.parpel_bg *</strong> class to add background
                                        color with card-header.</p>
                                </div>
                            </div>
                            <div class="box_body">
                                <div class="default-according" id="accordion2">
                                    <div class="card">
                                        <div class="card-header parpel_bg " id="headingseven">
                                            <h5 class="mb-0">
                                                <button class="btn  text_white collapsed" data-bs-toggle="collapse"
                                                    data-bs-target="#collapseseven" aria-expanded="false">Collapsible
                                                    Group Item #<span class="digits">1</span></button>
                                            </h5>
                                        </div>
                                        <div class="collapse" id="collapseseven" aria-labelledby="headingOne"
                                        ...
                                        <div class="card-header parpel_bg " id="headingeight">
                                            <h5 class="mb-0">
                                                <button class="btn  collapsed text_white" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapseeight">Collapsible Group Item #<span
                                                        class="digits">2</span></button>
                                            </h5>
                                        </div>
                                        ...
                                        <div class="card-header parpel_bg " id="headingnine">
                                            <h5 class="mb-0">
                                                <button class="btn  collapsed text_white" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapsenine">Collapsible Group Item #<span
                                                        class="digits">3</span></button>
                                            </h5>
                                        </div>
                                ...
                                <div class="default-according" id="accordion5">
                                        ...
                                        <div class="card-header pink_bg" id="headingFour0">
                                            <h5 class="mb-0">
                                                <button class="btn  text_white collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapseFour0"> <i
                                                        class="far fa-user-circle me-2"></i> Collapsible Group Item
                                                    #<span class="digits">1</span></button>
                                            </h5>
                                        </div>
                                        <div class="collapse" id="collapseFour0" aria-labelledby="headingOne"
                                    ...
                                    <div class="card">
                                        <div class="card-header pink_bg" id="headingFive0">
                                            <h5 class="mb-0">
                                                <button class="btn  collapsed text_white" data-bs-toggle="collapse"
                                                    data-bs-target="#collapseFive0" aria-expanded="false"
                                                    aria-controls="collapseFive"> <i
                                                        class="far fa-user-circle me-2"></i> Collapsible Group Item
                                                    #<span class="digits">2</span></button>
                                            </h5>
                                        </div>
                                        <div class="collapse" id="collapseFive0" aria-labelledby="headingFive0"
                                    ...
                                    <div class="card">
                                        <div class="card-header pink_bg" id="headingSix0">
                                            <h5 class="mb-0">
                                                <button class="btn  collapsed text_white" data-bs-toggle="collapse"
                                                    data-bs-target="#collapseSix0" aria-expanded="false"
                                                    aria-controls="collapseSix"> <i class="far fa-user-circle me-2"></i>
                                                    Collapsible Group Item #<span class="digits">3</span></button>
                                            </h5>
                                        </div>
                                        <div class="collapse" id="collapseSix0" aria-labelledby="headingSix0"
                                            data-parent="#accordion5">
                                            <div class="card-body">Anim pariatur cliche reprehenderit, enim eiusmod high
                                                life accusamus terry richardson ad squid. 3 wolf moon officia aute, non
                                                cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum
                    ...
                    <div class="col-lg-6">
                        <div class="card_box box_shadow position-relative mb_30">
                            <div class="white_box_tittle ">
                                <div class="main-title2 ">
                                    <h4 class="mb-2 nowrap">Color Accordion</h4>
                                    <p>Add <strong class="color_pink">.arrow_style*</strong> class in to
                                        default-according</p>
                                </div>
                            </div>
                            <div class="box_body">
                                        ...
                                        <div class="card-header parpel_bg ">
                                            <h5 class="mb-0">
                                                <button class="btn  text_white collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapse11"><i class="far fa-user-circle me-2"></i>
                                                    Collapsible Group Item #<span class="digits">1</span></button>
                                            </h5>
                                        </div>
                                        <div class="collapse" id="collapseicon" aria-labelledby="collapseicon"
                                            data-parent="#accordionoc" style>
                                            <div class="card-body">Anim pariatur cliche reprehenderit, enim eiusmod high
                                                life accusamus terry richardson ad squid. 3 wolf moon officia aute, non
                                                cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum
                                                eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid
    ...
    <script src="js/bootstrap.min.php"></script>
