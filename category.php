...
<body class="crm_body_bg">
    ...
    <section class="main_content dashboard_part large_header_bg">
        ...
        <div class="main_content_iner overly_inner col-lg-10 mt-5">
            <div class="container-fluid  ">

                <div class="row">
                    <div class="col-10">
                        <div class="page_title_box  align-items-center ">
                ...
                <div class="container">
                    <div class="row ">
                        <div class="col-md-12">
                            <div class=" position-relative mb_0">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">Id</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-primary mr-2">
                                                        <a href="update.php?id=<?php echo $dataVal['id']; ?>"
                                                            class="text-light">Update</a>
                                                    </button>
                                                    <button class="btn btn-danger">
                                                        <a href="delete.php?deleteid=<?php echo $dataVal['id']; ?>"
