...
if (isset($_POST['submit'])) {
    ...
    if (empty($name) || empty($price) || empty($description) || empty($category_id) || empty($image)) {
        $error = "Please fill in all the fields.";
    } else {
        // Insert data into the database
        $q = "INSERT INTO `products` (`product_id`, `product_name`, `price`, `description`, `id`, `image_url`) 
              VALUES (NULL, '$name', '$price', '$description', '$category_id', '$image')";
        if (mysqli_query($conn, $q)) {
            ...
            $error = "Failed to insert data into the database: " . mysqli_error($conn);
        }
    }
}
?>
                ...
                <div class="col-12">
                    <div class="dashboard_header mb_50">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="dashboard_breadcrumb text-end">
                ...
                <div class="modal-content cs_modal">
                    ...
                    <div class="modal-body">
                        <form method="post" enctype="multipart/form-data">
                            <div>
                                <input type="text" name="fname" class="form-control" placeholder="Product Name">
                            </div>
                            <div class="form-outline mb-4">
                                <input type="text" name="price" id="form2Example2" class="form-control" placeholder="Price" required/>
                            </div>
                            <div class="form-outline mb-4">
                                <textarea type="text" name="body" id="form2Example3" class="form-control" placeholder="Body" rows="8" required></textarea>
                            </div>
                            <div class="form-outline mb-4">
                            ...
                            <div class="form-outline mb-4">
                                <input type="file" name="post_image" id="form2Example4" class="form-control" placeholder="Image" />
                            </div>
                            <?php if (!empty($error)): ?>
