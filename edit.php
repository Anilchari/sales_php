...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($_FILES["image"]["name"]) {
        ...
        $query = "UPDATE products 
                  SET product_name = '$product_name', price = '$price', description = '$description', id = '$category_id', image_url = '$image'
                  WHERE product_id = '$product_id'";
    } else {
        $query = "UPDATE products 
                  SET product_name = '$product_name', price = '$price', description = '$description', id = '$category_id'
                  WHERE product_id = '$product_id'";
    }
...
<!-- Mirrored from demo.dashboardpack.com/sales-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 15:49:07 GMT -->
<head>
...
<h3 class="f_s_30 f_w_700 text_white">update</h3>
...
<!-- <a href="#" class="white_btn3">update Report</a> -->
</div>
</div>
</div>
<!doctype html>
...
<!-- Mirrored from demo.dashboardpack.com/sales-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 15:49:43 GMT -->
</html>
